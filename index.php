...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="carousel-image" src="./image/swastikroom.jpeg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/bar.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/swastikresturant.jpg">
            </div>
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="hotelswastiklogo" src="./image/hotelswastiklogo.png" alt="logo">
            <p>HOTELSWASTIK</p>
        </div>
